...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getSetting() async {
    ...
    if (response.statusCode == 200) {
      ...
      type = finalResult['booking_types']['car'] == null
          ? null
          : finalResult['booking_types']['car']['name'];
      type2 = finalResult['booking_types']['hotel'] == null
          ? null
          : finalResult['booking_types']['hotel']['name'];
      type3 = finalResult['booking_types']['tour'] == null
          ? null
          : finalResult['booking_types']['tour']['name'];
      type4 = finalResult['booking_types']['flight'] == null
          ? null
          : finalResult['booking_types']['flight']['name'];
      setState(() {});
      print("sdsddsd $type");
    } else {
                      ...
                      transitionsBuilder:
                        ...
                        return Opacity(
                          ...
                          if (App.localStorage.getString("token") != null) {
                            print(
                                '____sssssss______${App.localStorage.getString("token")}_________');
                            Navigator.push(
                                context,
                                MaterialPageRoute(
      ...
      if (finalResult['data'] != null) {
        for (int i = 0; i < (finalResult['data'] as List).length; i++) {
          if (finalResult['data'][i]['type'] == 'list_tours') {
            trendingTourism =
                TrendingTourismResponse.fromJson(finalResult['data'][i]);
          }
        }
...
class cardVacations extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.only(left: 0.0, right: 0.0, top: 8.0, bottom: 10.0),
      child: Column(
    ...
    return SizedBox(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            String image =
                'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F489977634460315180%2F&psig=AOvVaw2V4pvnO8xlVFW9DPpAjxOx&ust=1695715886221000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCIC-04qoxYEDFQAAAAAdAAAAABAE';
                ...
                children: <Widget>[
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(Assets.imagesTour),
                              fit: BoxFit.cover),
                          color: Colors.white,
                          boxShadow: [
                            BoxShadow(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              TourDetailNewScreen(list[i].slug!)));
                },
                child: Container(
                  height: 250,
                  decoration: BoxDecoration(
